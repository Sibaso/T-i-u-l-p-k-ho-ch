...
public class CBUS_mini_project_2 {
	...
	public void solve() {
		...
		for(int m=1;m<=K;m++) {
			...
			MPConstraint e = solver.makeConstraint(0,q[m]);
			for(int i=1;i<=N;i++) {
				e.setCoefficient(Z[i][m], 1);
				MPConstraint f = solver.makeConstraint(0,0);//diem i va i+N phai thuoc 1 lo trinh
	...
	public static void main(String[] args) {
		...
		CBUS_mini_project_2 x=new CBUS_mini_project_2(3,2);
		x.solve();
		x.printSolution();	
	}
}
